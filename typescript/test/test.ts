import { cholesky, lup, Matrix, solve, solveLowerTriangular, solveUpperTriangular } from '../src';
import {zeros, identity, diagFromArray, ones}  from '../src/init';
